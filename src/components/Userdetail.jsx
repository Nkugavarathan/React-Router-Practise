...
export default function Userdetail() {
  ...
  return (
    <div>
      ...
      <p>
        Address : <p> {userdetail.address.street},</p>
...
export const userSingleLoader = async ({ params }) => {
   ...
   * <Route
          ...
          /> ithula irukura ovuru elemnt um params kurikum namaku thevaiyana id ah destructe panni edukuram 
   */
  const { id } = params

  // Fetch data from the API endpoint using the 'id' parameter
